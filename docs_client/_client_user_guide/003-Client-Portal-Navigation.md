...
Every page in the portal has the same header. Learning it once means you can reach anything from
anywhere.
...
| Chat | *Open Chat* on an order | [007](007-Messages-and-Notifications.md) |
| Help | User menu → Help | — |
...
- **Notifications tell you when a quotation arrives.** The bell is the fastest way to know your
